...
public class FileUtils {
	 ...
	 * @param dataList
	 */
	public static void createCvsFile2(String fileName, String filePath, List<List<Object>> dataList, Object[] head) {
	 ...
	 * @throws IOException
	 */
	private static void writeRow2(List<Object> row, BufferedWriter csvWriter) throws IOException {
		String rowStr = "";
		for (Object data : row) {
			StringBuffer sb = new StringBuffer();
