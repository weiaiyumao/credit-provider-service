...
public class ApiMobileTestServiceImpl implements ApiMobileTestService {
	...
	// @Override
	public BackResult<List<MobileInfoDomain>> findByMobileNumbers2222(String mobileNumbers, String userId) {
	...
	public static void main(String[] args) {
		...
		for (String string : realdelivrds) {
			if (delivrd.equals(string)) {
				System.out.println("实号");
			}
		}
	...
	public BackResult<MobileInfoDomain> findByMobile(String mobile, String userId) {
		RedisLock lock = new RedisLock(redisTemplate, "shmobile_" + mobile + "_" + userId, 0, 3 * 1000);
		try {
