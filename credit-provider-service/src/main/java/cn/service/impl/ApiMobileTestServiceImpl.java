...
//						}
						...
						String status = MobileDetailHelper.getInstance().getMobileStatus(mobile, detail.getDelivrd());
...
//					domain.setLastTime(detail.getReportTime());
//					if ("real".equals(this.isSpaceMobile2(detail.getDelivrd()))) {
//						domain.setStatus("1"); // 实号
//					} else if ("kong".equals(this.isSpaceMobile2(detail.getDelivrd()))) {
//						domain.setStatus("0"); // 空号
//					} else if ("pause".equals(this.isSpaceMobile2(detail.getDelivrd()))) {
//						domain.setStatus("4"); // 沉默号
