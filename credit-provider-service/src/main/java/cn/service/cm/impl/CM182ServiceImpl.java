...
import cn.repository.cm.CM182Repository;
...
public class CM182ServiceImpl implements CM182Service {
	...
	@Autowired
	private CM182Repository repository;
	...
	public List<CM182> findByMobileAndReportTime(String mobile, Date startTime, Date endTime) {
		...
		Page<CM182> page  = repository.findByMobileAndReportTime(mobile,startTime,endTime,pageable);
	...
	public void deleteByMobile(BaseMobileDetail mobileDetail,String mobile) {
		List<CM182> resultList = this.findByMobile(mobile);
