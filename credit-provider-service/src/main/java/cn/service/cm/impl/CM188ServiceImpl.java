...
import cn.repository.cm.CM188Repository;
...
public class CM188ServiceImpl implements CM188Service {
	...
	@Autowired
	private CM188Repository repository;
	...
	public List<CM188> findByMobileAndReportTime(String mobile, Date startTime, Date endTime) {
		...
		Page<CM188> page  = repository.findByMobileAndReportTime(mobile,startTime,endTime,pageable);
	...
	public void deleteByMobile(BaseMobileDetail mobileDetail,String mobile) {
		List<CM188> resultList = this.findByMobile(mobile);
