...
import cn.repository.cm.CM184Repository;
...
public class CM184ServiceImpl implements CM184Service {
	...
	@Autowired
	private CM184Repository repository;
	...
	public List<CM184> findByMobileAndReportTime(String mobile, Date startTime, Date endTime) {
		...
		Page<CM184> page  = repository.findByMobileAndReportTime(mobile,startTime,endTime,pageable);
	...
	public void deleteByMobile(BaseMobileDetail mobileDetail,String mobile) {
		List<CM184> resultList = this.findByMobile(mobile);
