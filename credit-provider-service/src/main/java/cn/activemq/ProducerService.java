...
public class ProducerService {
	...
	public void consumerMessage(UserAccountDomain domain) {
		System.out.println("从out.queue队列收到的回复报文为:" + domain.getCreUserId() + "--" + domain.getApiAccount() + "--" + domain.getAccount());
	}
}
