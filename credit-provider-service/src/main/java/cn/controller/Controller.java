...
//    	BackResult<RunTestDomian> result = foreignService.runTheTest("D:/test/6f072674b763400b89f00b412445fabb_18717717701.txt", "17671",String.valueOf(System.currentTimeMillis()),"13817367247");
    	BackResult<RunTestDomian> result = foreignService.theTest2("C:/Users/ChuangLan/Documents/QQEIM Files/2881526637/FileRecv/新建文本文档 (44442).txt", "17671", "13817367247", "bendi", "0", type);
//    	System.out.println(new SimpleDateFormat("yyyyMMddHHmmssSSS") .format(new Date() ));
    	return result;
    }
